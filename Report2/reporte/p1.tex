...
From equation \eqref{eq:vol_beta} it is seen that it is necessary to calculate ethe density of each phase, which can be done by using the following equations \citet{callister2010materials}:
